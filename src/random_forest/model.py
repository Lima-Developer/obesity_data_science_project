"""RandomForestClassifier with preprocessing pipeline for the obesity dataset."""
...
class RandomForestModel:
    """Multiclass obesity level classifier using Random Forest.
    ...
    RandomForestClassifier. Designed for the UCI Obesity Levels dataset (id=544):
    ...
    def fit(self, X_train: pd.DataFrame, y_train: pd.DataFrame) -> "RandomForestModel":
